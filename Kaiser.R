...
KAISER_medical_providers$locations <- paste0(KAISER_medical_providers$Street, ", ", KAISER_medical_providers$City, ", ", KAISER_medical_providers$State, ", ", KAISER_medical_providers$Zip)