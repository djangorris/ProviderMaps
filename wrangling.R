...
psychology_103 <- bind_rows(SLICE_1_psychology_103, SLICE_2_psychology_103, SLICE_3_psychology_103, SLICE_4_psychology_103)
write_csv(psychology_103, path = "Processed_CSV/Specialties/psychology_103.csv")
