...
selected_specialty <- "012 Endocrinology"
...
ggmap(co_map, extent = "device") +
  # geom_density2d(data = endocrinology_012,
  #                aes(x = lon, y = lat),
  #                size = 0.3) +
  ...
  theme_provider_maps +
  ggsave(filename = "Plots/endocrinology_012.png", width = 9, height = 5, dpi = 1200)
