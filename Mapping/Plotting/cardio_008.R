...
selected_specialty <- "008 Cardiovascular Disease"
...
ggmap(co_map, extent = "device") +
  # geom_density2d(data = cardiovascular_dis_008,
  #                aes(x = lon, y = lat),
  #                size = 0.3) +
  ...
  theme_provider_maps +
  ggsave(filename = "Plots/cardiovascular_dis_008.png", width = 9, height = 5, dpi = 1200)
