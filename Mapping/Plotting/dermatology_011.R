...
selected_specialty <- "011 Dermatology"
...
ggmap(co_map, extent = "device") +
  # geom_density2d(data = dermatology_011,
  #                aes(x = lon, y = lat),
  #                size = 0.3) +
  ...
  theme_provider_maps +
  ggsave(filename = "Plots/dermatology_011.png", width = 9, height = 5, dpi = 1200)
