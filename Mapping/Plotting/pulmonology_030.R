# REPLACE:
# pulmonology_030 (target geocoded variable name)
# 030 Pulmonology (copy/paste from TOTAL_Specialty_Count spreadsheet on Desktop)

# GET COUNT FOR EACH CARRIER
selected_specialty <- "030 Pulmonology"
clean_selected_specialty <- str_replace_all(selected_specialty, " ", "_")
statewide_count_pulmonology_030 <- ALL_statewide_specialty_count %>%
